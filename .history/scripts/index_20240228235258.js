...
const elementodiv= document.body.createElement('div');
...
const contenedor= document.getElementsByTagName('elementodiv');

const repositori=new Repository();

const actividades = repositori.getallActivity();
