...
function cards(Activity){
    ...
    tituloElemento.classList.add('title');
    descripcionElemento.classList.add('description');
    imagenElemento.classList.add('imgUrl');
    tarjetaElemento.classList.add('cads');
...
function agregarActividadHandler() {
    ...
    if (!title || !description || !imgUrl) {
     ...
     this.repository.createActivity(title, description, imgUrl);
